...
class _AppLayoutState extends State<AppLayout> {
  ...
  List<Widget> _buildPages() {
    return [
      ...
      _buildReportPage(), // Báo Cáo
      const FloorLayoutScreen(), // Tại Bàn
      _buildSettingsPage(), // Cài Đặt
    ];
  }

  Widget _buildReportPage() {
    return Center(child: Text('Báo Cáo', style: TextStyle(fontSize: 24)));
  }
  Widget _buildSettingsPage() {
    return Center(child: Text('Cài Đặt', style: TextStyle(fontSize: 24)));
  }
    ...
    return SizedBox(
      ...
      child: Row(
        ...
        children: [
          ...
          const CircleAvatar(
            radius: 30,
            backgroundImage: AssetImage(Asset.bgImageAvatar), // Đảm bảo ảnh tồn tại trong assets
          ),
          SizedBox(width: MediaQuery.of(context).size.width * 0.01),
          Column(
